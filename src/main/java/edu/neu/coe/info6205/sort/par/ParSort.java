...
class ParSort {
    ...
    public static void sort(int[] array, int from, int to, ForkJoinPool  executor) {
        if (to - from < cutoff)
...
//            System.out.println("# threads: "+ ForkJoinPool.commonPool().getRunningThreadCount());
    ...
    private static CompletableFuture<int[]> parsort(int[] array, int from, int to, ForkJoinPool  executor) {
